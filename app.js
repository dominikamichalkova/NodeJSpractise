...
//on package.json file --> to run app without telling which file to run, standard way to execute app, now a script ,start' with a wrapped command to run app associated with this file which is associated with npm that says start is node app.js -> on cmd just execute ,npm start'
